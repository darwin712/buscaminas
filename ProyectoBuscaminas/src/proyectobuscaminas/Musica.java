...
public class Musica {
    ...
    public void playMusic(String filePath) {
        try {
            ...
            System.err.println("Error al reproducir musica: " + e.getMessage());
        }
    }
    ...
    public boolean wasPlayedOnce() { return wasPlayedOnce; }
    public void setWasPlayedOnce(boolean value) { this.wasPlayedOnce = value; }
}